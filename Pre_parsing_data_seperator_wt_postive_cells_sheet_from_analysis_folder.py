...
input_fname_nuclei="PositiveCells.csv"

fname_strings=['LC3_BS_Plate','casp3_BS_edge_1cAMPrap_Plate']  # should end with "_Plate"
...
df_positive=pd.read_csv(input_dir_base+input_fname_nuclei)
...
def search_and_save(df_GFAP,df_nuclei,save_dir_base,fname_string):
    ...
    df_positive_i= df_positive.loc[df_positive['FileName_DisplayImage'].str.contains(fname_string, case=False)]
    ...
    df_positive_i.to_csv(path_or_buf=save_dir_i + 'PositiveCells.csv',  index=None, header=True)
