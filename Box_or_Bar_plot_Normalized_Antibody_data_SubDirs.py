...
# row_order=['G', 'F', 'E', 'B', 'C', 'D']  # for 2_22
row_order=['F', 'G', 'B', 'C', 'D', 'E']   # order of rows by which to plot, Control must be first!, e.g. ['E', 'C', 'D', 'B', 'F', 'G']
...
# )
substring='_Plate'
dir_list = [i for i in dir_list if substring in i]
...
for input_dir in dir_list:
    ...
    base_directory = input_dir_base + '/' + input_dir
    filepath=glob.glob(base_directory+'**/*Thresholded_AntibodyResults_Column_means.csv')
