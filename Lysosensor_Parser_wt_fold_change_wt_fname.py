...
Custom_dir=r"E:\NewAnalysisSheetsAll8_29_21\New_Dye sheets\LysoSensor_sheets"
...
for input_dir in dir_list:
    ...
    input_fname_GFP="/GFAP.csv" # needs "/" in front
    ...
    mi=df[['ImageNumber','ObjectNumber','FileName_DisplayImage','Intensity_IntegratedIntensity_OrigGreen']]
    mi=mi.rename(columns={"Intensity_IntegratedIntensity_OrigGreen": "GFP_int_I"})
    ...
    means_columns['Fold_change_GFP_int_I']=means_columns['GFP_int_I'].copy()/float(means_rows_control['GFP_int_I'])
