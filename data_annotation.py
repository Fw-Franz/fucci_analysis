...
from main import TOTAL_NORM, RELATIVE_NORM, NORMALIZED_METHOD, REPLICATES, TECHNICAL, BIOLOGICAL, DATA_SCALE_METHODS, NORMAL_SCALE, LOG2_SCALE, RAW_METHOD, FOLD_CHANGE_METHOD, STATS_METHODS,TTEST,WILCOXIN, TUKEY, GAMESHOWELL
import pandas as pd
import numpy as np
import os
